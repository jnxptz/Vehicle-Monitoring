    ...
    <div class="dashboard-body">
        ...
        <div class="dashboard-container">
            <div class="page-header">
                <h2>Edit Boardmember</h2>
                <p class="page-description">Update boardmember information and office assignment.</p>
            </div>
            ...
            <div class="form-container">
                <form action="{{ route('boardmembers.update', $user->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-actions">
                        <a href="{{ route('offices.manage-boardmembers') }}" class="btn-secondary">Cancel</a>
                        <button type="submit" class="btn-primary">Update Boardmember</button>
                    </div>
                </form>
            </div>
        </div>
