...
<div class="dashboard-page">
    ...
    <div class="dashboard-body">
        ...
        <nav class="dashboard-nav">
            ...
            <a href="{{ route('admin.reports') }}"><svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6z"/><path d="M14 2v6h6M16 13H8M16 17H8M10 9H8"/></svg>Reports</a>
