        ...
        <div class="dashboard-container">
            ...
            <div class="kpi-grid" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px; margin-bottom: 24px;">
                ...
                <div class="kpi-card" style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.04); border-top: 4px solid #3b82f6;">
                    ...
                    <p style="margin: 0; font-size: 28px; font-weight: 700; color: #1e293b;">₱{{ number_format($rows->sum('yearlyBudget'), 2, '.', ',') }}</p>

                </div>



                <div class="kpi-card" style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.04); border-top: 4px solid #f59e0b;">
                    ...
                    <p style="margin: 0; font-size: 28px; font-weight: 700; color: #dc2626;">₱{{ number_format($rows->sum('totalUsed'), 2, '.', ',') }}</p>

                </div>



                <div class="kpi-card" style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.04); border-top: 4px solid #10b981;">
                    ...
                    <p style="margin: 0; font-size: 28px; font-weight: 700; color: #059669;">₱{{ number_format($rows->sum('remainingBudget'), 2, '.', ',') }}</p>

                </div>



                <div class="kpi-card" style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.04); border-top: 4px solid #8b5cf6;">

                    <h4 style="margin: 0 0 8px 0; font-size: 12px; color: #64748b; font-weight: 500; text-transform: uppercase; letter-spacing: 0.5px;">Total Liters ({{ $selectedMonthName }})</h4>

                    <p style="margin: 0; font-size: 28px; font-weight: 700; color: #1d4ed8;">{{ number_format($rows->sum('monthlyLitersUsed'), 2, '.', ',') }} L</p>
