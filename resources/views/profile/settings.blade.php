...
<div class="dashboard-page">
    <div class="dashboard-header">
        ...
        <div class="user-profile" onclick="toggleProfileDropdown(event)" style="cursor:pointer;">
            ...
            <div class="profile-dropdown" id="profileDropdown">
                <a href="{{ route('profile.settings') }}" class="profile-dropdown-item active">
                ...
                <form action="{{ route('logout') }}" method="POST" class="profile-dropdown-item-form">
                    @csrf
